...
// 🎯 NEW: ADMIN_EMAILS_BACKEND is replaced by this mutable cache variable 🎯
let ADMIN_EMAILS_BACKEND_CACHE = []; 
const SYSTEM_EMAIL_FOR_GLOBAL_TASKS = "systems@brightbraintech.com";


// 🎯 NEW FUNCTION: Fetch Admin Emails from BigQuery 🎯
async function fetchAdminEmails() {
    ...
    try {
        ...
        ADMIN_EMAILS_BACKEND_CACHE = rows.map(row => row.email);
        ...
        // In a real production environment, you might load a known safe fallback list here.
